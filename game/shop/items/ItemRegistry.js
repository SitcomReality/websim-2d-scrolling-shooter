// Centralized item registry for shop items.
// Contains the item definitions and activation logic formerly embedded in ItemFactory.
    ...
    applyOwned(ownedIds = [], player, context = {}) {
        ownedIds.forEach(id => {
            try {
                ...
                if (!it) return;
                // attempt to register defined stats
